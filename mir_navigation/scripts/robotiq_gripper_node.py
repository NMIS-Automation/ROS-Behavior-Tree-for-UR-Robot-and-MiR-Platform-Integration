...
class RobotiqGripperNode:
    def __init__(self):
        rospy.init_node('robotiq_gripper_node')
        ...
        self.close_sub = rospy.Subscriber('/gripper_close', Bool, self.close_callback)
        self.open_sub = rospy.Subscriber('/gripper_open', Bool, self.open_callback)
        self.action_completed_pub = rospy.Publisher('/gripper_action_completed', Bool, queue_size=10)
