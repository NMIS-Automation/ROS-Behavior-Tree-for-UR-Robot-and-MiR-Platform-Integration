...
class URRobotNode:
    def __init__(self):
        rospy.init_node('ur_robot_node')
        self.ip_address = rospy.get_param('~ur_ip_address', '10.1.1.2')
        self.rtde_c = None
        self.rtde_io = None
        
        self.connect()
        
        self.move_sub = rospy.Subscriber('/ur_move', Pose, self.move_callback)
        self.move_completed_pub = rospy.Publisher('/ur_move_completed', Bool, queue_size=10)
